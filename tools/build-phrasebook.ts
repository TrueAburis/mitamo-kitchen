...
<div class="wrap">
  ...
  <section class="sec">
    ...
    <p class="tplnote"><b>この形は、サイト側の取り込みが対応済みです。</b>先頭の【English Title】、【作り方】、[Steps] の3つとも読めるようになりました。手順を書いていただければ、日本語と英語がそのままレシピページの手順欄に入ります（日英で手順の数がそろっているときだけ英語も入ります）。これまでの書き方の回も、変わらず読めます。</p>
